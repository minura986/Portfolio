...
const Data = () => {
  ...
  const originalText = "Minura Sankalpa"; // Updated Name
  ...
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Full Stack Engineering Undergraduate</h3>
      <p className="home__description">Passionate about creating innovative web solutions. Currently pursuing my degree while building real-world applications.</p>
